...
import {
  type DateInputExample,
  type ProductCard,
  type CarouselExample,
  type CarouselExampleItem,
  type ButtonExample,
  type IconButtonExample,
} from "../../types/TouchpointBasicExamplesTypes";
...
export const CarouselExampleComponent = ({
  data,
  conversationHandler,
}: {
  data: CarouselExample;
  conversationHandler: any;
}) => {
  const handler = conversationHandler;
...
export const ButtonExampleComponent = ({
  data,
  conversationHandler,
}: {
  data: ButtonExample;
...
export const IconButtonExampleComponent = ({
  data,
  conversationHandler,
}: {
  data: IconButtonExample;
  conversationHandler: any;
}) => {
  const handler = conversationHandler;
  console.log(data);
...
export const DateInputExampleComponent = ({
  data,
  conversationHandler,
}: {
  data: DateInputExample;
  conversationHandler: any;
}) => {
  return (
    <DateInput
